...
public class TransmittableTest extends TestCase {
    ...
    public void testTick() throws Exception {
        ...
        try {
            ...
            File file = new File("C:/Users/Tsunko/Downloads/(C85)(同人音楽)(東方)%5BForeground Eclipse%5D Stories That Last Thorough the Sleepless Nights (256K MP3).rar");
            ...
            ByteBuffer data = ByteBuffer.allocate(Long.BYTES + Byte.BYTES + Integer.BYTES + fileName.length * Character.BYTES + Long.BYTES + 32);
            data.put((byte) 0x02);
            data.putLong(fileName.length * Character.BYTES + Integer.BYTES + Long.BYTES + 32);
            ...
            data.putLong(file.length());
            data.put(HashUtils.computeHash(file));
            for(int i=0; i < 10; i++){
